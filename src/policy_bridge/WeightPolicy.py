...
from src.policy_bridge.Parameters import Parameters
from src.policy_bridge.utils import DTYPE

from src.policy_bridge.reformat import omegaconf_to_dict, print_dict
...
class WeightPolicy:
    ...
    def compute_observations(self, _base_pos, _base_lin_vel, _base_ang_vel, _commands, _dof_pos, _dof_vel, _actions):
        base_lin_vel = _base_lin_vel * self.lin_vel_scale
        base_ang_vel = _base_ang_vel * self.ang_vel_scale
        # projected_gravity = - _projected_gravity
        commands = _commands * np.array([self.lin_vel_scale, self.lin_vel_scale, self.ang_vel_scale], dtype=DTYPE)
        dof_pos = _dof_pos * self.dof_pos_scale
        dof_vel = _dof_vel * self.dof_vel_scale
        
        observations = np.concatenate((_base_pos,
                                       base_lin_vel, 
                                       base_ang_vel, 
                                    #    projected_gravity, 
                                       commands, 
